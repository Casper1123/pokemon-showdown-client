...
lastTurn=function(){var _this$battle0;
(_this$battle0=_this.battle)==null||_this$battle0.seekTurn(Infinity);
};_this.
goToTurn=function(e){var _this$base,_this$battle1;
...
(_this$battle1=_this.battle)==null||_this$battle1.seekTurn(turnNum);
_this.closeTurn(e);
};_this.
switchViewpoint=function(){var _this$battle10,_this$battle11;
(_this$battle10=_this.battle)==null||_this$battle10.switchViewpoint();
if((_this$battle11=_this.battle)!=null&&_this$battle11.viewpointSwitched){
...
changeSound=function(e){var _this$battle12;
var muted=e.target.value;
(_this$battle12=_this.battle)==null||_this$battle12.setMute(muted==='off');

BattleSound.setBgmVolume(muted==='musicoff'?0:65.88125800126558);
_this.forceUpdate();
};_this.
changeVolume=function(e){var _this$battle13,_this$battle14;
var volume=Number(e.target.value);
BattleSound.setBgmVolume(volume);
BattleSound.setEffectVolume(volume);
(_this$battle13=_this.battle)==null||_this$battle13.setMute(true);
(_this$battle14=_this.battle)==null||_this$battle14.setMute(false);
_this.forceUpdate();
};_this.
