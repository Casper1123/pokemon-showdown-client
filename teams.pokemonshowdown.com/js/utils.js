...
var team=[];for(var _i0=0,_buf$split2=

buf.split("]");_i0<_buf$split2.length;_i0++){var setBuf=_buf$split2[_i0];
...
var vals=document.cookie.split(';');for(var _i10=0;_i10<
vals.length;_i10++){var cookie=vals[_i10];
