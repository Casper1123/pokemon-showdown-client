...
abilities=abilities.map(toID);for(var _i18=0,_this$getAllActive4=
...
var temp={0:{},1:{},2:{},3:{}};for(var _i22=0;_i22<
sides.length;_i22++){var side=sides[_i22];
...
sideConditions.length;_i24++){var _id2=sideConditions[_i24];
...
case'-cureteam':{
var _poke20=this.getPokemon(args[1]);for(var _i48=0,_poke20$side$pokemon2=
_poke20.side.pokemon;_i48<_poke20$side$pokemon2.length;_i48++){var _target2=_poke20$side$pokemon2[_i48];
_target2.status='';
...
this.activateAbility(_poke23,oldAbility.name);
this.scene.wait(500);
this.activateAbility(_poke23,ability.name,true);
_ofpoke0==null||_ofpoke0.rememberAbility(ability.name);
...
_poke25.searchid=args[1].substr(0,2)+args[1].substr(args[1].indexOf(':'))+'|'+args[2];

this.scene.animTransform(_poke25,true,true);
this.log(args,kwArgs);
break;
}
case'-transform':{
...
_poke26.addVolatile('formechange',speciesForme);for(var _i50=0,_tpoke$moveTrack2=
...
this.scene.animTransform(_poke27,true);
this.log(args,kwArgs);
break;
}
case'-mega':{
...
if(_poke29.speciesForme.startsWith("Morpeko")){
lockForme=true;
_poke29.speciesForme=_poke29.getSpeciesForme();
_poke29.details=_poke29.details.replace("Morpeko",_poke29.speciesForme);
_poke29.searchid=_poke29.ident+"|"+_poke29.details;
delete _poke29.volatiles['formechange'];
}
this.scene.animTransform(_poke29,true,lockForme);
...
if(kwArgs.silent&&!(_effect14.id==='protosynthesis'||_effect14.id==='quarkdrive')){
...
_poke34.item='';
_poke34.itemEffect='';
_poke34.prevItem=kwArgs.item;
_poke34.prevItemEffect='given away';
...
_poke34.removeTurnstatus('protect');for(var _i52=0,_poke34$side$pokemon2=
_poke34.side.pokemon;_i52<_poke34$side$pokemon2.length;_i52++){var curTarget=_poke34$side$pokemon2[_i52];
...
var foeActive=[];for(var _i54=0,_poke34$side$foe$acti2=
_poke34.side.foe.active;_i54<_poke34$side$foe$acti2.length;_i54++){var maybeTarget=_poke34$side$foe$acti2[_i54];
...
this.addPseudoWeather(_effect21.name,_minTimeLeft,_maxTimeLeft);

switch(_effect21.id){
case'gravity':
if(this.seeking!==null)break;for(var _i56=0,_this$getAllActive0=
this.getAllActive();_i56<_this$getAllActive0.length;_i56++){var _active=_this$getAllActive0[_i56];
...
this.useMove(_poke42,_move2,poke2,kwArgs);
this.animateMove(_poke42,_move2,poke2,kwArgs);
...
this.cantUseMove(_poke43,effect,_move3,kwArgs);
this.log(args,kwArgs);
break;
}
case'gen':{
...
var _poke44=this.getPokemon(args[2]);
_poke44.removeVolatile('terastallize');
_poke44.teraType='';
_poke44.terastallized='';
_poke44.details=_poke44.details.replace(/, tera:[a-z]+/i,'');
_poke44.searchid=_poke44.searchid.replace(/, tera:[a-z]+/i,'');
this.scene.animTransform(_poke44);
this.scene.resetStatbar(_poke44);
this.log(args,kwArgs);
}
break;
}
