...
set.ivs={hp:31,atk:31,def:31,spa:31,spd:31,spe:31};for(var _i0=0;_i0<
ivLines.length;_i0++){var ivLine=ivLines[_i0];
...
if(!Array.isArray(team))throw new Error("Team should be an Array but isn't");for(var _i10=0;_i10<
team.length;_i10++){var set=team[_i10];
...
lines.length;_i12++){var line=lines[_i12];
line=line.trim();
if(line===''||line==='---'){
curSet=null;
