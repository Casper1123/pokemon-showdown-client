...
}else if(highlightName){for(var _i0=0,_node$children0=
node.children;_i0<_node$children0.length;_i0++){var _child2=_node$children0[_i0];
...
var numLeaves=0;
var hasLeafAtDepth=[];
this.forEachTreeNode(newTree,function(node,depth){var _node$children1;
hasLeafAtDepth[depth]||(hasLeafAtDepth[depth]=false);
if(!((_node$children1=node.children)!=null&&_node$children1.length)){
numLeaves++;
...
children(function(node){var _node$children10;return(
(_node$children10=node.children)!=null&&_node$children10.length?node.children:null);}
);
