...
break;
case'teamupdate':for(var _i0=0,_PS$teams$list2=
PS.teams.list;_i0<_PS$teams$list2.length;_i0++){var _team=_PS$teams$list2[_i0];
...
getDefaultTeam=function getDefaultTeam(teambuilderFormat){for(var _i10=0,_PS$teams$list4=
PS.teams.list;_i10<_PS$teams$list4.length;_i10++){var team=_PS$teams$list4[_i10];
...
if(!this.format){
this.format="gen"+Dex.gen+"randombattle";for(var _i12=0;_i12<
starred.length;_i12++){var id=starred[_i12];
