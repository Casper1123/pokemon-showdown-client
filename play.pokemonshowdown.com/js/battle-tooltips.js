...
stats.spa=Math.floor(stats.spa*1.5);
}for(var _i28=0,_Dex$statNamesExceptH8=
Dex.statNamesExceptHP;_i28<_Dex$statNamesExceptH8.length;_i28++){var _statName3=_Dex$statNamesExceptH8[_i28];
...
if(!short){
var hasModifiedStat=false;for(var _i32=0,_Dex$statNamesExceptH0=
Dex.statNamesExceptHP;_i32<_Dex$statNamesExceptH0.length;_i32++){var statName=_Dex$statNamesExceptH0[_i32];
...
Dex.statNamesExceptHP;_i34<_Dex$statNamesExceptH10.length;_i34++){var _statName4=_Dex$statNamesExceptH10[_i34];
...
var _boostCount2=0;for(var _i50=0,_Object$values6=
Object.values(pokemon.boosts);_i50<_Object$values6.length;_i50++){var _boost2=_Object$values6[_i50];
...
for(var _i51=1;_i51<=5&&_i51<=pokemon.side.faintCounter;_i51++){
if(pokemon.volatiles["fallen"+_i51]){
value.abilityModify([1,1.15,1.3,1.45,1.6,1.75][_i51],"Hardcore Hustle");
}
}
...
for(var _i52=1;_i52<=5&&_i52<=pokemon.side.faintCounter;_i52++){
if(pokemon.volatiles["fallen"+_i52]){
value.abilityModify(1+0.05*_i52,"The Eminence in the Shadow");
}
}
}
...
if(fusionSpecies.exists&&fusionSpecies.name!==species.name){for(var _i56=0,_Object$values8=
Object.values(fusionSpecies.abilities);_i56<_Object$values8.length;_i56++){var newAbility=_Object$values8[_i56];
...
Dex.statNames;_i58<_Dex$statNames2.length;_i58++){var _origSpread$evs;var stat=_Dex$statNames2[_i58];
...
}for(var _i64=0,_Dex$statNames4=
Dex.statNames;_i64<_Dex$statNames4.length;_i64++){var _stat3=_Dex$statNames4[_i64];
...
Dex.statNames;_i66<_Dex$statNames6.length;_i66++){var _stat4=_Dex$statNames6[_i66];
