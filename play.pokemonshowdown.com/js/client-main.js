...
}for(var _i0=0,_Object$values2=


Object.values(teams);_i0<_Object$values2.length;_i0++){var _team4=_Object$values2[_i0];
var matched=false;for(var _i10=0,_this3$list4=
_this3.list;_i10<_this3$list4.length;_i10++){var _localTeam=_this3$list4[_i10];
...
for(var _i11 in normalizeList){
normalizeRegexes.push([new RegExp('['+normalizeList[_i11]+']','g'),_i11]);
}for(var _i13=0;_i13<

replaceRegexes.length;_i13++){var _ref2=replaceRegexes[_i13];var regex=_ref2[0];var replacement=_ref2[1];
name=name.replace(regex,replacement);
}for(var _i15=0;_i15<
normalizeRegexes.length;_i15++){var _ref3=normalizeRegexes[_i15];var _regex=_ref3[0];var _replacement=_ref3[1];
...
if(!rooms.length)return this.add('||You do not have any PM windows open.');for(var _i17=0;_i17<
rooms.length;_i17++){var _roomid5=rooms[_i17];
PS.leave(_roomid5);
}
...
for(var _i18=0,_len2=targets.length;_i18<_len2;_i18++){
if(!targets[_i18])continue;
if(/[\\^$*+?()|{}[\]]/.test(targets[_i18])){

try{
new RegExp(targets[_i18]);
}catch(e){
return this.add("|error|"+(e.message.substr(0,28)==='Invalid regular expression: '?e.message:'Invalid regular expression: /'+targets[_i18]+'/: '+e.message));
}
}
if(highlightList.includes(targets[_i18])){
return this.add("|error|"+targets[_i18]+" is already on your highlights list.");
}
}
...
var newHls=[];
for(var _i19=0,_len3=_highlightList.length;_i19<_len3;_i19++){
if(!targets.includes(_highlightList[_i19])){
newHls.push(_highlightList[_i19]);
}
}
...
_this1.addRoom({id:toID(title),title:title,connected:true},true);
}
}
...
var isInit=false;for(var _i25=0,_msg$split2=
msg.split('\n');_i25<_msg$split2.length;_i25++){var _room;var line=_msg$split2[_i25];
...
addRoomType=function addRoomType(){for(var _len4=arguments.length,types=new Array(_len4),_key5=0;_key5<_len4;_key5++){types[_key5]=arguments[_key5];}for(var _i27=0;_i27<
types.length;_i27++){var RoomType=types[_i27];
this.roomTypes[RoomType.id]=RoomType;for(var _i29=0,_RoomType$routes2=
RoomType.routes;_i29<_RoomType$routes2.length;_i29++){var route=_RoomType$routes2[_i29];
...
if(options.backlog){for(var _i31=0,_options$backlog2=
options.backlog;_i31<_options$backlog2.length;_i31++){var args=_options$backlog2[_i31];
...
var autojoins=[];
var autojoinCount=0;
var rooms=this.rightRoomList;for(var _i33=0;_i33<
rooms.length;_i33++){var _roomid7=rooms[_i33];
