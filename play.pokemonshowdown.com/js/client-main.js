...
this.loggingIn=name;
this.update(null);
OfficialAuth.getAssertion(this).then(function(res){
if(res===null){
OfficialAuth.authorize(_this5);
}else{
...
authorize=function authorize(user){var _window$location$path,_this12=this;
