...
this.onlineUsers=[];for(var _i0=0;_i0<
usernames.length;_i0++){var username=usernames[_i0];
...
var message='';
var list=[];
var named={};for(var _i10=0;_i10<
preList.length;_i10++){var item=preList[_i10];
...
ChatLog=function(_preact$Component5){function ChatLog(){var _this0;for(var _len5=arguments.length,args=new Array(_len5),_key5=0;_key5<_len5;_key5++){args[_key5]=arguments[_key5];}_this0=_preact$Component5.call.apply(_preact$Component5,[this].concat(args))||this;_this0.



subscription=null;return _this0;}_inheritsLoose(ChatLog,_preact$Component5);var _proto7=ChatLog.prototype;_proto7.
componentDidMount=function componentDidMount(){var _this1=this;
var room=this.props.room;
if(room.log){
...
room.backlog=null;for(var _i12=0;_i12<
backlog.length;_i12++){var args=backlog[_i12];
...
if(!tokens)return;
_this1.props.room.log.add(tokens,undefined,undefined,PS.prefs.timestamps[room.pmTarget?'pms':'chatrooms']);
});
}
