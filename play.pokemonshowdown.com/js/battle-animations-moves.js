...
lunarblessing:{
anim:function(scene,_ref68){var attacker=_ref68[0],defenders=_ref68.slice(1);for(var _i6=0;_i6<
...
shelltrap:{
anim:function(scene,_ref182){var attacker=_ref182[0],defenders=_ref182.slice(1);for(var _i8=0;_i8<
...
scene.backgroundEffect('#000000',1300,0.2);for(var _i42=0;_i42<
...
surf:{
anim:function(scene,_ref335){var attacker=_ref335[0],defenders=_ref335.slice(1);for(var _i45=0;_i45<
defenders.length;_i45++){var _defender6=defenders[_i45];
...
defenders.length;_i47++){var _defender7=defenders[_i47];
...
defenders.length;_i49++){var defender=defenders[_i49];
scene.showEffect('fireball',{
x:attacker.x,
y:attacker.y,
z:attacker.z,
...
dragonenergy:{
anim:function(scene,_ref340){var attacker=_ref340[0],defenders=_ref340.slice(1);for(var _i51=0;_i51<
...
eruption:{
anim:function(scene,_ref341){var attacker=_ref341[0],defenders=_ref341.slice(1);for(var _i53=0;_i53<
defenders.length;_i53++){var _defender8=defenders[_i53];
...
waterspout:{
anim:function(scene,_ref342){var attacker=_ref342[0],defenders=_ref342.slice(1);for(var _i55=0;_i55<
defenders.length;_i55++){var _defender9=defenders[_i55];
...
prepareAnim:function(scene,_ref345){var attacker=_ref345[0];
scene.showEffect('electroball',{
x:attacker.x-60,
y:attacker.y+40,
z:attacker.z,
...
scene.backgroundEffect("url('https://"+Config.routes.client+"/sprites/gen6bgs/bg-icecave.jpg')",1000,0.6);for(var _i57=0;_i57<
defenders.length;_i57++){var defender=defenders[_i57];
scene.showEffect('icicle',{
x:defender.x,
y:defender.y,
z:defender.z,
...
darkvoid:{
anim:function(scene,_ref370){var attacker=_ref370[0],defenders=_ref370.slice(1);for(var _i59=0;_i59<
defenders.length;_i59++){var _defender0=defenders[_i59];
_defender0.anim({
y:_defender0.y-80,
opacity:0,
time:300
...
scene.backgroundEffect('#FF99FF',700,0.3);for(var _i61=0;_i61<

defenders.length;_i61++){var _defender1=defenders[_i61];
...
scene.backgroundEffect('#000000',1300,0.3);for(var _i63=0;_i63<

defenders.length;_i63++){var _defender10=defenders[_i63];
...
z:attacker.z,
time:250
},'decel');for(var _i65=0;_i65<
defenders.length;_i65++){var defender=defenders[_i65];
var xstep=(defender.x-attacker.x)/5;
var ystep=(defender.x-200-attacker.x)/5;
var zstep=(defender.z-attacker.z)/5;
for(var i=0;i<5;i++){
...
scene.backgroundEffect('linear-gradient(#46AF71 20%, #1170F0)',1600,0.4,300);for(var _i67=0;_i67<

defenders.length;_i67++){var _defender11=defenders[_i67];
...
z:attacker.behind(-150)+zstep*(_i68+1),
scale:1.3,
opacity:1,
time:5*_i68+900
},{
...
scene.showEffect('wisp',{
x:attacker.leftof(50)+xstep*(_i69+1),
y:attacker.y+275+ystep*(_i69+1),
z:attacker.z+zstep*(_i69+1),
scale:1.3,
opacity:1,
time:5*_i69+1100
},{
x:defender.leftof(50)+xstep*(_i69+1),
opacity:0,
time:100*_i69+1200
},'linear');
}
...
defenders.length;_i85++){var _defender12=defenders[_i85];
...
opacity:0,
time:200
},'decel');for(var _i87=0;_i87<

defenders.length;_i87++){var defender=defenders[_i87];
...
x:defender.x+x2[_i88]*50,
y:defender.y+y2[_i88]*38,
time:1100
