...
var userSets={};for(var _i28=0,_ref4=

((_window$PS=window.PS)==null?void 0:_window$PS.teams.list)||[];_i28<_ref4.length;_i28++){var _window$PS;var team=_ref4[_i28];
if(team.format!==this.format||!team.isBox)continue;

var setList=Teams.unpack(team.packedTeam);
var duplicateNameIndices={};for(var _i30=0;_i30<

setList.length;_i30++){var _boxSet$species,_userSets$_boxSet$spe;var boxSet=setList[_i30];
...
for(var _i33=0;_i33<set.moves.length+1;_i33++){
if(!set.moves[_i33]){
set.moves[_i33]=name;
break;
}
...
render=function render(){var _this0=this;
var editor=this.props.editor;
...
preact.h("button",{"class":"button notifying",onClick:_this0.pasteSet,value:i},
preact.h("i",{"class":"fa fa-clipboard","aria-hidden":true})," Paste copy here"
)," ",
!willNotMove(i)&&preact.h("button",{"class":"button notifying",onClick:_this0.moveSet,value:i,disabled:clipboard.readonly},
...
preact.h("button",{"class":"button",onClick:_this0.undeleteSet},
...
StatForm=function(_preact$Component4){function StatForm(){var _this1;for(var _len4=arguments.length,args=new Array(_len4),_key5=0;_key5<_len4;_key5++){args[_key5]=arguments[_key5];}_this1=_preact$Component4.call.apply(_preact$Component4,[this].concat(args))||this;_this1.
...
var _this1$props=_this1.props,editor=_this1$props.editor,set=_this1$props.set;
var team=editor.team;

var guess=new BattleStatGuesser(team.format).guess(set);
set.evs=guess.evs;
_this1.plus=guess.plusStat||null;
_this1.minus=guess.minusStat||null;
_this1.updateNatureFromPlusMinus();
_this1.props.onChange();
};_this1.
handleOptimize=function(){
var _this1$props2=_this1.props,editor=_this1$props2.editor,set=_this1$props2.set;
var team=editor.team;
...
_this1.plus=optimized.plus||null;
_this1.minus=optimized.minus||null;
_this1.props.onChange();
};_this1.
...
var maxEv=_this1.maxEVs();
if(maxEv<6*252){
var totalEv=0;for(var _i35=0,_Object$values5=
Object.values(set.evs||{});_i35<_Object$values5.length;_i35++){var curEv=_Object$values5[_i35];totalEv+=curEv;}
...
var set=_this1.props.set;
if(!_this1.plus||!_this1.minus){
delete set.nature;
}else{
for(var i in BattleNatures){
if(BattleNatures[i].plus===_this1.plus&&BattleNatures[i].minus===_this1.minus){
set.nature=i;
break;
}
}
...
var set=_this1.props.set;
var statID=target.name.split('-')[1];
var value=_this1.dvToIv(target.value);
if(value===null){
if(set.ivs){
...
if(maxEv<6*252){
var totalEv=0;for(var _i39=0,_Object$values7=
Object.values(set.evs||{});_i39<_Object$values7.length;_i39++){var ev=_Object$values7[_i39];totalEv+=ev;}
if(totalEv<=maxEv){
...
DetailsForm=function(_preact$Component5){function DetailsForm(){var _this11;for(var _len5=arguments.length,args=new Array(_len5),_key6=0;_key6<_len5;_key6++){args[_key6]=arguments[_key6];}_this11=_preact$Component5.call.apply(_preact$Component5,[this].concat(args))||this;_this11.
