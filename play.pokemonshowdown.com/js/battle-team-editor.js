...
if(!set.moves.length)minAtk=false;for(var _i0=0,_set$moves6=
set.moves;_i0<_set$moves6.length;_i0++){var moveName=_set$moves6[_i0];
...
if(abilityid==='wonderguard'){for(var _i10=0;_i10<
types.length;_i10++){var type=types[_i10];
...
types.length;_i12++){var _type=types[_i12];
...
var coverage={};
var species=this.dex.species.get(set.species);
var abilityid=toID(set.ability);for(var _i14=0,_this$dex$types$names2=
this.dex.types.names();_i14<_this$dex$types$names2.length;_i14++){var type=_this$dex$types$names2[_i14];
...
var counters={};for(var _i16=0,_this$dex$types$names4=
this.dex.types.names();_i16<_this$dex$types$names4.length;_i16++){var type=_this$dex$types$names4[_i16];
counters[type]={
type:type,
resists:0,
neutrals:0,
...
}for(var _i18=0,_this$sets2=
this.sets;_i18<_this$sets2.length;_i18++){var set=_this$sets2[_i18];
var coverage=this.pokemonDefensiveCoverage(set);for(var _i20=0,_Object$entries2=
Object.entries(coverage);_i20<_Object$entries2.length;_i20++){var _ref2=_Object$entries2[_i20];var _type2=_ref2[0];var value=_ref2[1];
if(value<1){
...
for(var _i23=0;_i23<set.moves.length+1;_i23++){
if(!set.moves[_i23]){
set.moves[_i23]=name;
break;
}
...
if(maxEv<6*252){
var totalEv=0;for(var _i25=0,_Object$values2=
Object.values(set.evs||{});_i25<_Object$values2.length;_i25++){var curEv=_Object$values2[_i25];totalEv+=curEv;}
...
if(maxEv<6*252){
var totalEv=0;for(var _i29=0,_Object$values4=
Object.values(set.evs||{});_i29<_Object$values4.length;_i29++){var ev=_Object$values4[_i29];totalEv+=ev;}
if(totalEv<=maxEv){
...
preact.h("td",{"class":"setstatbar"},_this0.renderStatbar(stat,statID)),
...
onInput:_this0.changeEV,onChange:_this0.changeEV}
)),
preact.h("td",null,preact.h("input",{
...
type:"number",inputMode:"numeric","class":"textbox default-placeholder",onInput:_this0.changeIV,onChange:_this0.changeIV}
)),
...
DetailsForm=function(_preact$Component5){function DetailsForm(){var _this1;for(var _len5=arguments.length,args=new Array(_len5),_key5=0;_key5<_len5;_key5++){args[_key5]=arguments[_key5];}_this1=_preact$Component5.call.apply(_preact$Component5,[this].concat(args))||this;_this1.
